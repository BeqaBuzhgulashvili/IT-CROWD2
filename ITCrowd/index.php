						...
						<nav class="navbar_ navbar navbar-expand-md clearfix">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="nav navbar-nav sf-menu clearfix">
									<li class="nav-item"><a href="index.php" class="nav-link active"><?=$tr["home"][$lang];?></a></li>
				...
				<div class="content-inner">
							...
							<div id="slides">
								<ul class="slides-container">
									<li>
										...
										<div class="caption">
											<div class="">
												<div class="txt1"><?=$tr["slider_title1"][$lang];?></div>
												<div class="txt2">IT <?=$tr["support"][$lang];?><br><span>&</span> <?=$tr["services_big"][$lang];?></div>
												<div class="txt3"><?=$tr["slide_subtext"][$lang];?></div>
												<div class="link1"><a href="contact.php" class="btn1 button"><?=$tr["respond"][$lang];?></a></div>
											</div>
										</div>
									</li>
									<li>
										...
										<div class="caption">
											<div class="">
												<div class="txt1"><?=$tr["slider_title2"][$lang];?></div>
												<div class="txt2">IT <?=$tr["consultation"][$lang];?><br><span>&</span> <?=$tr["services_big"][$lang];?></div>
												<div class="txt3"><?=$tr["slide_subtext"][$lang];?></div>
												<div class="link1"><a href="contact.php" class="btn1  button"><?=$tr["respond"][$lang];?></a></div>
											</div>
										</div>
									...
									<li>
										...
										<div class="caption">
											<div class="">
												<div class="txt1"><?=$tr["slider_title3"][$lang];?></div>
												<div class="txt2">IT <?=$tr["audit"][$lang];?><br><span>&</span> <?=$tr["services_big"][$lang];?></div>
												<div class="txt3"><?=$tr["slide_subtext"][$lang];?></div>
												<div class="link1"><a href="contact.php" class="btn1 button"><?=$tr["respond"][$lang];?></a></div>
											</div>
										</div>
								...
								<nav class="slides-navigation">
									<a href="#" class="prev"><?=$tr["prev"][$lang];?></a><span>|</span><a href="#" class="next"><?=$tr["next"][$lang];?></a>
								</nav>
							</div>
						</div>
						<div class="left-panel">
							<div class="social-left-txt"><?=$tr["follow"][$lang];?></div>
					...
					<div id="about" class="page-section">
						...
						<div class="container">
							...
							<div class="title2"><br><?=$tr["bureau_text"][$lang];?></div>
						</div>
					</div>
					<div id="our-projects" class="page-section">
						<div class="back-txt">services</div>
						<div class="container">
							<div class="title1"><?=$tr["our"][$lang];?> <span><?=$tr["services"][$lang];?></span></div>
							<div class="title2"><?=$tr["our_text"][$lang];?></div>
						</div>
						<br><br>
						<div class="projects clearfix">
							<div class="project">
								<a href="images/it-produvtion.jpg" class="fancybox">
									<figure><img src="images/service1.jpg" alt="service1" class="img-fluid"></figure>
									<div class="over1"></div>
									<div class="txt1">IT<br><?=$tr["products"][$lang];?></div>
									<div class="caption">
										<div class="txt2">ITCrowd</div>
										<div class="txt3"><?=$tr["service_text1"][$lang];?></div>
									</div>
							...
							<div class="project">
								<a href="images/s4.jpg" class="fancybox">
									<figure><img src="images/service4.jpg" alt="service2" class="img-fluid"></figure>
									<div class="over1"></div>
									<div class="txt1">IT<br><?=$tr["consultation"][$lang];?></div>
									<div class="caption">
										<div class="txt2">ITCrowd</div>
										<div class="txt3"><?=$tr["service_text2"][$lang];?></div>
									</div>
									<div class="over2"><i class="fa fa-search-plus" aria-hidden="true"></i></div>
								</a>
							</div>
							<div class="project">
								<a href="images/service.jpg" class="fancybox">
									<figure><img src="images/service2.jpg" alt="service3" class="img-fluid"></figure>
									<div class="over1"></div>
									<div class="txt1">IT<br><?=$tr["service"][$lang];?></div>
									<div class="caption">
										<div class="txt2">ITCrowd</div>
										<div class="txt3"><?=$tr["service_text3"][$lang];?></div>
									</div>
									<div class="over2"><i class="fa fa-search-plus" aria-hidden="true"></i></div>
								</a>
							</div>
							<div class="project">
								<a href="images/s3.jpg" class="fancybox">
									<figure><img src="images/service3.jpg" alt="service4" class="img-fluid"></figure>
									<div class="over1"></div>
									<div class="txt1"><?=$tr["common"][$lang];?><br><?=$tr["audit"][$lang];?></div>
									<div class="caption">
										<div class="txt2">ITCrowd</div>
										<div class="txt3"><?=$tr["service_text4"][$lang];?></div>
									</div>
									<div class="over2"><i class="fa fa-search-plus" aria-hidden="true"></i></div>
								</a>
							</div>
					...
					<div class="percentages">
						<div class="container">
							...
							<div class="title1"><?=$tr["our"][$lang];?> <span><?=$tr["team"][$lang];?></span></div>
								<div class="row">
									<div class="col-md-6">
										<div class="percentage1">
											<div class="txt1">IT <?=$tr["managers"][$lang];?></div>
											<div class="txt2">IT <?=$tr["projects"][$lang];?></div>
											<div class="bg">
									...
									<div class="col-md-6">
										<div class="percentage1">
											<div class="txt1"><?=$tr["sysadmins"][$lang];?></div>
											<div class="txt2"><?=$tr["servers"][$lang];?></div>
											<div class="bg">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="percentage1">
											<div class="txt1"><?=$tr["networkers"][$lang];?></div>
											<div class="txt2"><?=$tr["network"][$lang];?></div>
											<div class="bg">
									...
									<div class="col-md-6">
										<div class="percentage1">
											<div class="txt1"><?=$tr["troubleshooters"][$lang];?></div>
											<div class="txt2"><?=$tr["computers"][$lang];?></div>
											<div class="bg">
